...
public class MyDate {
    ...
    public void inputDate() {
        ...
        String m = day.nextLine();
        this.setMonth(m);

        System.out.print("Enter year: ");
        String y = day.nextLine();
        this.setYear(y);
    }
    ...
    public void printDate1(){
        System.out.print("My date (mm/dd/yyyy) is: ");
        System.out.println(this.getMonth() + "/" + this.getDate() + "/" + this.getYear());
    }
    public void printDate2(){
        System.out.print("My date (yyyy/mm/dd) is: ");
        System.out.println(this.getYear() + "/" + this.getMonth() + "/" + this.getDate());
    }
}